...
Name of the dataset: full_dataset_cities
...
2. Composition of dataset (what's in the data?)
 ...
 Full_dataset_cities is the merged dataset of both the 5 high inflation and the 5 low inflation cities. The variables we used are the host characteristics: host_since, host_response_time, host_response_rate, hoste_is_super_host, host_has_profile_pic, host_idendity_verified
