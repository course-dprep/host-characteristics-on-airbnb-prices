...
Name of the dataset: dataset1_Amsterdam

----------------------------------------------------------

1. Motivation of data collection (why was the data collected?) 

Due to inflation it was valuable to look at the prices of Airbnb's in two big cities in the Netherlands. We are looking at the effect of host characteristics on these prices.

2. Composition of dataset (what's in the data?)

We will use the variables prices and host chracteristics from the datasets.
